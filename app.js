...
riot.tag2('soundcloud', '<div class="{opts.styles.soundcloudContainer}"> <div class="{opts.styles.soundcloudCenterContainer}"> <iframe width="100%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/81505872&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe> </div> </div>', '', '', function(opts) {

	this.on('mount', function() {

	});
}, '{ }');
riot.tag2('videos', '<div class="{opts.styles.videosContainer}"> <div class="{opts.styles.videosCenterContainer}"> <h2>DEMO</h2> <iframe width="560" height="315" src="https://www.youtube.com/embed/3qxm8ChG4sg" frameborder="0" allowfullscreen></iframe> <h2>TUTORIAL</h2> <iframe width="560" height="315" src="https://www.youtube.com/embed/o9YezPSmFpQ" frameborder="0" allowfullscreen></iframe> </div> </div>', '', '', function(opts) {
